import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, n as Primitive, p as composeEventHandlers, q as createContextScope, m as useComposedRefs$1, F as useDirection, G as useCallbackRef, H as Presence, s as cn, u as useMachineStore, I as useAcknowledgeAlert, l as Button, J as Bell, B as Badge, K as ScrollArea, M as CircleX, T as TriangleAlert } from "./index-DlaMAZ3N.js";
import { C as Card } from "./card-CsCFZSSd.js";
import { n as useId, e as useControllableState, T as Trash2, I as Input, D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogFooter, u as ue, X } from "./index-DkTwamNF.js";
import { e as createCollection, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-PD3JDCYT.js";
/**
...
function tsMs(alert) {
  return Number(alert.timestamp) / 1e6;
}
function timeAgo(ms) {
...
function exportCsv(alerts) {
  ...
  anchor.href = url;
  anchor.download = `alerts-${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.csv`;
  anchor.click();
...
function AlertRow({
  ...
  const ms = tsMs(alert);
  const [highlight, setHighlight] = reactExports.useState(isNew);
  reactExports.useEffect(() => {
    if (!isNew) return;
    const t = setTimeout(() => setHighlight(false), 1800);
    return () => clearTimeout(t);
  }, [isNew]);
  const borderColor = isAcked ? "rgba(255,255,255,0.12)" : isCritical ? "#ff4444" : "#ffd700";
  const bgColor = highlight ? "rgba(255,215,0,0.08)" : isAcked ? "rgba(255,255,255,0.03)" : isCritical ? "rgba(255,68,68,0.05)" : "rgba(255,215,0,0.04)";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shrink-0 flex flex-col items-center gap-1", children: [
          isAcked ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-4 w-4 text-[#00ff88]" }) : isCritical ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { className: "h-4 w-4 text-[#ff4444]" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-4 w-4 text-[#ffd700]" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: "text-[9px] font-bold px-1 py-0.5 rounded leading-none",
              style: {
                backgroundColor: isAcked ? "rgba(0,255,136,0.15)" : isCritical ? "#ff4444" : "#ffd700",
                color: isAcked ? "#00ff88" : isCritical ? "#fff" : "#000"
              },
              children: isAcked ? "ACK" : isCritical ? "CRITICAL" : "WARNING"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-36 shrink-0 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-white truncate leading-tight", children: alert.machineName }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/60 truncate leading-tight mt-0.5", children: alert.sensorName })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: alert.value.toFixed(2)
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-white/40 leading-tight mt-0.5", children: isCritical ? "Critical threshold exceeded" : "Warning threshold exceeded" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shrink-0 text-right mr-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] text-white/40 leading-tight", children: formatTime(ms) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-white/30 leading-tight mt-0.5", children: timeAgo(ms) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 shrink-0", children: [
          !isAcked && /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              variant: "ghost",
              size: "icon",
...
function KpiChip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: { borderColor: `${color2}30`, backgroundColor: `${color2}08` },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-white/50 font-medium uppercase tracking-wide leading-tight", children: label })
      ]
    }
  );
}
function AlertsPage() {
  ...
  const [machineFilter, setMachineFilter] = reactExports.useState("all");
  const [severityTab, setSeverityTab] = reactExports.useState("all");
  const [timeRange, setTimeRange] = reactExports.useState("all");
  const [clearDialogOpen, setClearDialogOpen] = reactExports.useState(false);
  const [newAlertIds, setNewAlertIds] = reactExports.useState(/* @__PURE__ */ new Set());
  const prevAlertsRef = reactExports.useRef(alerts);
  reactExports.useEffect(() => {
    ...
    if (freshIds.length > 0) {
      setNewAlertIds((ids) => {
        ...
        for (const id2 of freshIds) next.add(id2);
        return next;
      });
      setTimeout(() => {
        setNewAlertIds((ids) => {
          const next = new Set(ids);
          for (const id2 of freshIds) next.delete(id2);
          return next;
        });
      }, 2e3);
    }
  ...
  const handleAcknowledge = async (id2) => {
    try {
      await acknowledgeAlert.mutateAsync(id2);
    } catch {
    }
    setAlerts(
      alerts.map((a) => a.id === id2 ? { ...a, acknowledged: true } : a)
    );
    ue.success("Alert acknowledged");
  };
  const handleDismiss = (id2) => {
    setAlerts(alerts.filter((a) => a.id !== id2));
  };
  const handleClearAll = () => {
    setAlerts([]);
    setClearDialogOpen(false);
    ue.success("All alerts cleared");
  };
  const handleExport = () => {
    exportCsv(filtered);
    ue.success(`Exported ${filtered.length} alerts to CSV`);
  };
  const now2 = Date.now();
  const timeMs = {
    "1h": 36e5,
  ...
  const filtered = alerts.filter((a) => {
    const ms = tsMs(a);
    if (timeMs[timeRange] !== Number.POSITIVE_INFINITY && now2 - ms > timeMs[timeRange])
      return false;
    ...
    if (search) {
      ...
      if (!a.machineName.toLowerCase().includes(q) && !a.sensorName.toLowerCase().includes(q))
        return false;
    }
    return true;
  });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-4", "data-ocid": "alerts.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between flex-wrap gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-xl text-white tracking-tight", children: "Alerts & Notifications" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/40 mt-0.5", children: "Real-time alert feed — auto-updates every 3s" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3", "data-ocid": "alerts.stats_row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(KpiChip, { label: "Total Alerts", value: totalCount, color: "#00d4ff" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(KpiChip, { label: "Critical", value: criticalCount, color: "#ff4444" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(KpiChip, { label: "Unacknowledged", value: unackedCount, color: "#ffd700" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1 min-w-[200px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "absolute left-3 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-white/30" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: machineFilter, onValueChange: setMachineFilter, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            SelectTrigger,
            {
              className: "w-44 h-8 text-xs border-white/15 bg-white/5 text-white/70",
              "data-ocid": "alerts.machine_filter",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "All Machines" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { className: "bg-[#111118] border-white/15 text-white", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", className: "text-xs", children: "All Machines" }),
            machines.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: m.id, className: "text-xs", children: m.name }, m.id))
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Select,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { className: "bg-[#111118] border-white/15 text-white", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "1h", className: "text-xs", children: "Last hour" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "24h", className: "text-xs", children: "Last 24h" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", className: "text-xs", children: "All time" })
              ] })
            ]
          }
        )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          value: severityTab,
          onValueChange: (v) => setSeverityTab(v),
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "h-8 bg-white/5 border border-white/10 gap-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              TabsTrigger,
              {
                value: "all",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              TabsTrigger,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[#ffd700]", children: [
                  "⚠ Warning (",
                  alerts.filter(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              TabsTrigger,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[#ff4444]", children: [
                  "✕ Critical (",
                  criticalCount,
                  ")"
                ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Card,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-2.5 border-b border-white/10 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "h-3.5 w-3.5 text-white/40" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] uppercase tracking-widest text-white/40 font-medium", children: [
                filtered.length,
                " event",
                filtered.length !== 1 ? "s" : ""
              ] }),
              filtered.length < alerts.length && /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-white/25 font-mono", children: "newest first" })
          ] }),
          filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-10 w-10 text-[#00ff88]/30" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white/40", children: "No alerts to display" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/25", children: alerts.length > 0 ? "Try adjusting your filters" : "System is running normally" })
              ]
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "h-[500px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { initial: false, children: filtered.map((alert, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            AlertRow,
            {
              alert,
              index: i + 1,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: clearDialogOpen, onOpenChange: setClearDialogOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      DialogContent,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "text-white flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-4 w-4 text-[#ff4444]" }),
            "Clear all alerts?"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-white/60 pt-1", children: [
            "This will permanently remove all",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-semibold", children: alerts.length }),
            " ",
            "alert",
            alerts.length !== 1 ? "s" : "",
