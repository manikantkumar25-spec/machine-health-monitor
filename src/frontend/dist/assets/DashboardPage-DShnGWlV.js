import { c as createLucideIcon, a as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, b as clsx, o, i as invariant, u as useMachineStore, d as computeFailureProbability, j as jsxRuntimeExports, S as Skeleton, A as Activity, B as Badge, T as TriangleAlert } from "./index-DlaMAZ3N.js";
...
const Vibrate = createLucideIcon("vibrate", __iconNode$1);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function Surface(props) {
  ...
  return /* @__PURE__ */ o.createElement("svg", _extends$r({}, filterProps(others, true, "svg"), {
...
var Layer = /* @__PURE__ */ o.forwardRef(function(props, ref) {
  ...
  return /* @__PURE__ */ o.createElement("g", _extends$q({
    className: layerClass
...
var Symbols = function Symbols2(_ref) {
  ...
  if (cx === +cx && cy === +cy && size === +size) {
    return /* @__PURE__ */ o.createElement("path", _extends$p({}, filteredProps, {
  ...
  return _createClass$j(DefaultLegendContent2, [{
    ...
    value: function renderItems() {
      ...
      return payload.map(function(entry, i) {
        ...
        return /* @__PURE__ */ o.createElement("li", _extends$o({
          className,
          style: itemStyle,
...
var DefaultTooltipContent = function DefaultTooltipContent2(props) {
  ...
  return /* @__PURE__ */ o.createElement("div", _extends$n({
    className: wrapperCN,
    style: finalStyle
...
var Text = function Text2(_ref5) {
  ...
  return /* @__PURE__ */ o.createElement("text", _extends$m({}, filterProps(textProps, true), {
    x: x2,
    y: y2,
...
function _getPrototypeOf$c(o2) {
  _getPrototypeOf$c = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf2(o22) {
...
function _setPrototypeOf$c(o2, p2) {
  _setPrototypeOf$c = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf2(o22, p22) {
    o22.__proto__ = p22;
    return o22;
  };
...
var renderRadialLabel = function renderRadialLabel2(labelProps, label, attrs) {
  ...
  return /* @__PURE__ */ o.createElement("text", _extends$k({}, attrs, {
...
function Label(_ref4) {
  ...
  return /* @__PURE__ */ o.createElement(Text, _extends$k({
...
var parseLabel = function parseLabel2(label, viewBox) {
  ...
  if (isObject$8(label)) {
    return /* @__PURE__ */ o.createElement(Label, _extends$k({
      viewBox
    }, label, {
      key: "label-implicit"
    }));
...
function LabelList(_ref) {
  ...
  return /* @__PURE__ */ o.createElement(Layer, {
    ...
    return /* @__PURE__ */ o.createElement(Label, _extends$j({}, filterProps(entry, true), others, idProps, {
...
function parseLabelList(label, data) {
  ...
  if (isObject$8(label)) {
    return /* @__PURE__ */ o.createElement(LabelList, _extends$j({
      data
    }, label, {
      key: "labelList-implicit"
    }));
...
var Rectangle = function Rectangle2(rectangleProps) {
  ...
  return /* @__PURE__ */ o.createElement(Animate, {
    ...
    }, /* @__PURE__ */ o.createElement("path", _extends$g({}, filterProps(props, true), {
      className: layerClass,
...
var Brush = /* @__PURE__ */ function(_PureComponent) {
  ...
  return _createClass$c(Brush2, [{
    ...
    value: function renderText() {
      ...
      }, /* @__PURE__ */ o.createElement(Text, _extends$c({
        textAnchor: "end",
        verticalAnchor: "middle",
        x: Math.min(startX, endX) - offset,
        y: y2 + height / 2
      }, attrs), this.getTextOfTick(startIndex)), /* @__PURE__ */ o.createElement(Text, _extends$c({
        textAnchor: "start",
        verticalAnchor: "middle",
...
function BarRectangle(props) {
  return /* @__PURE__ */ o.createElement(Shape, _extends$b({
    shapeType: "rectangle",
  ...
  return _createClass$b(Bar2, [{
    ...
    value: function renderBackground() {
      ...
      return data.map(function(entry, i) {
        ...
        return /* @__PURE__ */ o.createElement(BarRectangle, _extends$a({
...
var renderLine = function renderLine2(option, props) {
  ...
  if (/* @__PURE__ */ o.isValidElement(option)) {
    ...
    line = /* @__PURE__ */ o.createElement("line", _extends$9({}, props, {
...
_defineProperty$b(ReferenceDot, "renderDot", function(option, props) {
  ...
  if (/* @__PURE__ */ o.isValidElement(option)) {
    ...
    dot = /* @__PURE__ */ o.createElement(Dot, _extends$8({}, props, {
      cx: props.cx,
      cy: props.cy,
...
_defineProperty$a(ReferenceArea, "renderRect", function(option, props) {
  ...
  if (/* @__PURE__ */ o.isValidElement(option)) {
    ...
    rect = /* @__PURE__ */ o.createElement(Rectangle, _extends$7({}, props, {
...
var CartesianAxis = /* @__PURE__ */ function(_Component) {
  ...
  return _createClass$6(CartesianAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      return /* @__PURE__ */ o.createElement("line", _extends$6({}, props, {
    ...
    value: (
      ...
      function renderTicks(ticks2, fontSize, letterSpacing) {
        ...
        var items = finalTicks.map(function(entry, i) {
          ...
          return /* @__PURE__ */ o.createElement(Layer, _extends$6({
            className: "recharts-cartesian-axis-tick",
            key: "tick-".concat(entry.value, "-").concat(entry.coordinate, "-").concat(entry.tickCoord)
          }, adaptEventsOfChild(_this2.props, entry, i)), tickLine && /* @__PURE__ */ o.createElement("line", _extends$6({}, tickLineProps, lineCoord, {
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ o.isValidElement(option)) {
        tickItem = /* @__PURE__ */ o.cloneElement(option, _objectSpread$5(_objectSpread$5({}, props), {}, {
        ...
        tickItem = /* @__PURE__ */ o.createElement(Text, _extends$6({}, props, {
...
function renderLineItem(option, props) {
  ...
  if (/* @__PURE__ */ o.isValidElement(option)) {
    ...
    lineItem = /* @__PURE__ */ o.createElement("line", _extends$5({}, restOfFilteredProps, {
      x1,
      y1,
      x2,
      y2,
...
function CartesianGrid(props) {
  ...
  }), /* @__PURE__ */ o.createElement(HorizontalGridLines, _extends$5({}, propsIncludingDefaults, {
    offset,
    horizontalPoints,
    xAxis,
    yAxis
  })), /* @__PURE__ */ o.createElement(VerticalGridLines, _extends$5({}, propsIncludingDefaults, {
    offset,
    verticalPoints,
    xAxis,
    yAxis
  })), /* @__PURE__ */ o.createElement(HorizontalStripes, _extends$5({}, propsIncludingDefaults, {
    horizontalPoints
  })), /* @__PURE__ */ o.createElement(VerticalStripes, _extends$5({}, propsIncludingDefaults, {
    verticalPoints
  })));
}
...
var Line = /* @__PURE__ */ function(_PureComponent) {
  ...
  return _createClass$5(Line2, [{
    ...
    value: function renderCurveStatically(points, needClip, clipPathId, props) {
      ...
      return /* @__PURE__ */ o.createElement(Curve, _extends$4({}, curveProps, {
    ...
    value: function renderDotItem(option, props) {
      ...
      if (/* @__PURE__ */ o.isValidElement(option)) {
        ...
        dotItem = /* @__PURE__ */ o.createElement(Dot, _extends$4({
          key
        }, dotProps, {
          className
        }));
...
function DarkTooltip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        label && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/40 mb-1 font-mono", children: label }),
...
function Sparkline({ data, color: color2 = CYAN }) {
  ...
  reactExports.useEffect(() => {
    ...
    const pts = data.map((v2, i) => ({
      x: i / (data.length - 1) * w,
      y: h2 - (v2 - min2) / range3 * (h2 - 4) - 2
    }));
    ctx.beginPath();
    ...
    ctx.lineWidth = 1.5;
    ctx.stroke();
    ctx.lineTo(pts[pts.length - 1].x, h2);
    ctx.lineTo(pts[0].x, h2);
    ctx.closePath();
    const grad = ctx.createLinearGradient(0, 0, 0, h2);
    grad.addColorStop(0, `${color2}40`);
    grad.addColorStop(1, `${color2}00`);
    ctx.fillStyle = grad;
    ctx.fill();
  }, [data, color2]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("canvas", { ref: canvasRef, width: 80, height: 28, className: "opacity-80" });
}
function WearGauge({ percent }) {
  ...
  const color2 = percent >= 70 ? CRIT : percent >= 40 ? WARN : CYAN;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx, cy, r: 4, fill: color2 }),
...
function KpiCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Card,
    {
      ...
      "data-ocid": ocid,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "kpi-label text-[10px]", children: label }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-3xl font-bold tabular-nums text-foreground", children: value }),
          unit2 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: unit2 })
        ] }),
...
function SensorTile({
  ...
  const statusColor = status === "Critical" ? CRIT : status === "Warning" ? WARN : GOOD;
  const sparkColor = status === "Critical" ? CRIT : status === "Warning" ? WARN : CYAN;
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "kpi-label text-[10px]", children: name })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Sparkline,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-3xl font-bold tabular-nums text-foreground", children: typeof value === "number" ? value.toFixed(name.toLowerCase().includes("vib") ? 2 : 1) : "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: unit2 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base ml-auto", style: { color: statusColor }, children: trend })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Badge,
            {
              ...
              children: status === "Good" ? "NORMAL" : status.toUpperCase()
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function DashboardPage() {
  ...
  const sensorHistoryRef = reactExports.useRef({});
  const machine = reactExports.useMemo(
    () => machines.find((m2) => m2.id === selectedMachineId) ?? machines[0] ?? null,
    [machines, selectedMachineId]
  );
  const machineReadings = reactExports.useMemo(() => {
    if (!machine) return {};
    return Object.fromEntries(
      Object.entries(liveReadings).filter(
        ([k2]) => k2.startsWith(`${machine.id}-`)
      )
    );
  ...
  const sensorTiles = reactExports.useMemo(() => {
    ...
    return [
      {
        ...
        unit: "°C",
        icon: Thermometer,
        match: (n2) => n2.toLowerCase().includes("temp")
      },
      {
        name: "Vibration",
        key: "Vibration",
        unit: "mm/s",
        icon: Vibrate,
        match: (n2) => n2.toLowerCase().includes("vib")
      },
      {
        name: "Load",
        key: "Load",
        unit: "%",
        icon: Gauge,
        match: (n2) => n2.toLowerCase().includes("load")
      },
      {
        name: "Speed",
        key: "Speed",
        unit: "RPM",
        icon: Zap,
        match: (n2) => n2.toLowerCase().includes("speed") || n2.toLowerCase().includes("rpm")
      }
    ].map((tile) => {
      const snap = entries.find((e3) => tile.match(e3.sensorName));
      const hist = snap ? (buf[snap.sensorName] ?? []).map((p2) => p2.value) : [];
      return { ...tile, snap, history: hist };
    });
  }, [machine, machineReadings]);
  const currentWear = reactExports.useMemo(() => {
    if (!machine) return 0;
    const records = wearHistory.filter((w) => w.machineId === machine.id);
    return records.length > 0 ? records[records.length - 1].wearPercent : 0;
  }, [machine, wearHistory]);
  const wearStatus = currentWear >= 70 ? "Critical" : currentWear >= 40 ? "Warning" : "Good";
  const maintenanceEstimate = reactExports.useMemo(() => {
    if (currentWear >= 90) return "IMMEDIATE";
    if (currentWear >= 70) return "~2 WEEKS";
    if (currentWear >= 40) return "~2 MONTHS";
    return "~6 MONTHS";
  }, [currentWear]);
  const wearChartData = reactExports.useMemo(() => {
    if (!machine) return [];
    const liveRecords = wearHistory.filter((w) => w.machineId === machine.id).slice(-20);
    if (liveRecords.length >= 3) {
      return liveRecords.map((w) => ({
        time: new Date(Number(w.timestamp) / 1e6).toLocaleTimeString(
          "en-US",
    ...
    const seed = [];
    for (let i = 23; i >= 0; i--) {
      const t2 = new Date(now2 - i * 36e5);
      const progress = (24 - i) / 24;
      const baseWear = 5 + (currentWear - 5) * progress + (Math.random() - 0.5) * 1.5;
      seed.push({
        time: t2.toLocaleTimeString("en-US", {
          hour: "2-digit",
          minute: "2-digit"
        }),
        wear: Math.max(
  ...
  const machineProductionData = reactExports.useMemo(
    () => productionData.filter((p2) => p2.machineId === ((machine == null ? void 0 : machine.id) ?? "")),
    [machine, productionData]
  );
  const totalProduction = reactExports.useMemo(
    () => machineProductionData.reduce((sum, p2) => sum + Number(p2.count), 0),
    [machineProductionData]
  );
  const productionRate = reactExports.useMemo(() => {
    const recent = machineProductionData.slice(-20);
    if (recent.length < 2) return 0;
    const total = recent.reduce((sum, p2) => sum + Number(p2.count), 0);
    return Math.round(total / recent.length * 20);
  }, [machineProductionData]);
  const productionChartData = reactExports.useMemo(() => {
    if (!machine) return [];
    const live = machineProductionData.slice(-30);
    if (live.length >= 5) {
      let cumulative2 = 0;
      return live.map((p2) => {
        cumulative2 += Number(p2.count);
        return {
          time: new Date(Number(p2.timestamp) / 1e6).toLocaleTimeString(
            "en-US",
            { hour: "2-digit", minute: "2-digit" }
          ),
          count: cumulative2
    ...
    const now2 = Date.now();
    const hourlyBase = machine.status === "Idle" ? 40 : machine.status === "Fault" ? 0 : 280;
    let cumulative = 0;
    const seed = [];
    for (let i = 23; i >= 0; i--) {
      const t2 = new Date(now2 - i * 36e5);
  ...
  const sensorTrendData = reactExports.useMemo(() => {
    if (!machine) return [];
    const buf = sensorHistoryRef.current[machine.id] ?? {};
    const keys2 = ["Temperature", "Vibration", "Load", "Speed (RPM)"];
    const maxValues = {
      Temperature: 100,
      Vibration: 1.2,
      Load: 100,
    ...
    const maxLen = Math.max(...keys2.map((k2) => (buf[k2] ?? []).length), 0);
    if (maxLen < 2) {
      const now2 = Date.now();
      return Array.from({ length: 20 }, (_, i) => ({
        time: new Date(now2 - (19 - i) * 1e4).toLocaleTimeString("en-US", {
          hour: "2-digit",
          minute: "2-digit",
          second: "2-digit"
        }),
        Temperature: Math.round((55 + Math.sin(i * 0.4) * 8 + Math.random() * 4) * 10) / 10,
        Vibration: Math.round(
          (0.35 + Math.sin(i * 0.3) * 0.08 + Math.random() * 0.05) * 100
        ) / 100,
        Load: Math.round((65 + Math.sin(i * 0.5) * 12 + Math.random() * 6) * 10) / 10
      }));
    }
    const liveNow = Date.now();
    return Array.from({ length: Math.min(maxLen, 20) }, (_, idx) => {
      const point2 = {
        time: new Date(liveNow - (maxLen - 1 - idx) * 3e3).toLocaleTimeString(
          "en-US",
      ...
      for (const key of keys2) {
        ...
        if (entry) {
          const pct = Math.min(
            100,
            Math.round(entry.value / (maxValues[key] ?? 100) * 1e3) / 10
          );
          const displayKey = key.replace(" (RPM)", "");
          point2[displayKey] = pct;
        }
      }
      return point2;
    });
  }, [machine]);
  const runningCount = reactExports.useMemo(
    () => machines.filter((m2) => m2.status === "Running").length,
    [machines]
  );
  const fleetEfficiency = machines.length > 0 ? Math.round(runningCount / machines.length * 100) : 0;
  const machineAlerts = reactExports.useMemo(() => {
    if (!machine) return [];
    return alerts.filter((a2) => a2.machineId === machine.id && !a2.acknowledged).slice(0, 5);
  }, [machine, alerts]);
  const failureProbability = reactExports.useMemo(
    () => computeFailureProbability(
      currentWear,
      machineAlerts.filter((a2) => a2.severity === "Critical").length,
      0,
      0
    ),
  ...
  if (!machine) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-4", "data-ocid": "dashboard.loading_state", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 w-full" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-3", children: [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-24" }, i)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-3", children: [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-28" }, i)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-48 w-full" })
    ] });
  }
  const statusColor = machine.status === "Running" ? GOOD : machine.status === "Fault" ? CRIT : WARN;
  const wearColor = wearStatus === "Critical" ? CRIT : wearStatus === "Warning" ? WARN : CYAN;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-4", "data-ocid": "dashboard.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "h-4 w-4", style: { color: CYAN } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-sm text-foreground", children: machine.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground hidden sm:block", children: machine.machineType })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1.5 text-[10px] text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono", children: [
              machines.length,
              " MACHINES TRACKED"
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-bold", children: "LIVE" })
                ]
              }
            )
          ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] uppercase tracking-widest text-white/30 mb-2", children: "KEY PERFORMANCE INDICATORS" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              KpiCard,
              {
                ...
                unit: "UNITS/HR",
                sub: machine.status === "Running" ? "On target" : machine.status === "Idle" ? "Idle" : "Fault — stopped",
                subColor: machine.status === "Running" ? GOOD : machine.status === "Idle" ? WARN : CRIT,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              KpiCard,
              {
                ...
                unit: "%",
                sub: fleetEfficiency >= 80 ? "Excellent" : fleetEfficiency >= 50 ? "Moderate" : "Low — check faults",
                subColor: fleetEfficiency >= 80 ? GOOD : fleetEfficiency >= 50 ? WARN : CRIT,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              KpiCard,
              {
                ...
                unit: "RUNNING",
                sub: `${machines.filter((m2) => m2.status === "Fault").length} fault${machines.filter((m2) => m2.status === "Fault").length !== 1 ? "s" : ""} detected`,
                subColor: machines.filter((m2) => m2.status === "Fault").length > 0 ? CRIT : GOOD,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] uppercase tracking-widest text-white/30 mb-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: sensorTiles.map((tile, i) => {
            var _a, _b, _c;
            return /* @__PURE__ */ jsxRuntimeExports.jsx(
              SensorTile,
              {
                name: tile.name,
                value: ((_a = tile.snap) == null ? void 0 : _a.value) ?? 0,
                unit: ((_b = tile.snap) == null ? void 0 : _b.unit) ?? tile.unit,
                status: ((_c = tile.snap) == null ? void 0 : _c.status) ?? "Good",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] uppercase tracking-widest text-white/30 mb-2", children: "PRODUCTION & SENSOR TRENDS" }),
          ...
          Card,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "kpi-label text-[10px]", children: "Production Over Time" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground font-mono", children: "LAST 24 HRS" })
              ] }),
                ...
                AreaChart,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "prodGrad", x1: "0", y1: "0", x2: "0", y2: "1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "5%", stopColor: CYAN, stopOpacity: 0.3 }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "95%", stopColor: CYAN, stopOpacity: 0.02 })
                    ] }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      CartesianGrid,
                      {
          ...
          Card,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "kpi-label text-[10px]", children: "Sensor Trends (Normalized)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-[9px] font-mono", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: CYAN }, children: "● TEMP" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: WARN }, children: "● VIB" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: CRIT }, children: "● LOAD" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 160, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                LineChart,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] uppercase tracking-widest text-white/30 mb-2", children: "MACHINE HEALTH & WEAR PROGRESSION" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-3", children: [
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  ...
                  children: wearStatus === "Good" ? "GOOD" : wearStatus === "Warning" ? "WARNING" : "CRITICAL"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(WearGauge, { percent: currentWear }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full space-y-3 text-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] uppercase tracking-widest text-white/30 mb-0.5", children: "WEAR LEVEL" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "p",
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-px bg-white/5" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] uppercase tracking-widest text-white/30 mb-0.5", children: "FAILURE RISK" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "p",
                    {
                      className: "font-mono font-bold text-base",
                      style: {
                        color: failureProbability > 50 ? CRIT : failureProbability > 25 ? WARN : GOOD
                      },
                      children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-px bg-white/5" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] uppercase tracking-widest text-white/30 mb-0.5", children: "REPLACEMENT NEEDED" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: "font-mono font-bold text-sm",
                      style: { color: wearColor },
                      children: maintenanceEstimate
                    }
                  )
                ] })
              ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Card,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "kpi-label text-[10px]", children: "Wear Progression" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-[9px] font-mono", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: WARN }, children: "— WARN 40%" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: CRIT }, children: "— CRIT 70%" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                AreaChart,
                {
                  ...
                  margin: { top: 4, right: 4, left: -20, bottom: 0 },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "wearGrad", x1: "0", y1: "0", x2: "0", y2: "1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "5%", stopColor: CYAN, stopOpacity: 0.4 }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "95%", stopColor: CYAN, stopOpacity: 0.02 })
                    ] }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      CartesianGrid,
      ...
      Card,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-3.5 w-3.5", style: { color: WARN } }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "kpi-label text-[10px]", children: [
              "Active Alerts — ",
              machine.name
            ] }),
            machineAlerts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: "text-[10px] px-1.5 py-0.5 rounded-full font-bold text-white",
                style: { backgroundColor: CRIT },
                children: machineAlerts.length
              }
            )
          ] }),
          machineAlerts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: GOOD }, children: "All systems operating normally" })
              ]
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: machineAlerts.map((alert, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "flex items-center gap-3 px-3 py-2 rounded border",
              style: {
                borderColor: alert.severity === "Critical" ? `${CRIT}40` : `${WARN}40`,
                backgroundColor: alert.severity === "Critical" ? `${CRIT}0a` : `${WARN}0a`
              },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
                    ...
                    style: {
                      backgroundColor: alert.severity === "Critical" ? CRIT : WARN,
                      color: alert.severity === "Critical" ? "white" : "#000"
                    },
                    children: alert.severity.toUpperCase()
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono flex-1 min-w-0 truncate", children: [
                  alert.sensorName.toUpperCase(),
                  " — ",
                  alert.value.toFixed(1),
                  " ",
                  alert.severity === "Critical" ? "⚠" : "!"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-[10px] text-muted-foreground shrink-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-3 w-3" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: new Date(
                    Number(alert.timestamp) / 1e6
